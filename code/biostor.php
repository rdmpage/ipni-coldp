...
foreach ($data as $obj)
{
	...
	$doc = new stdclass;
	$doc->BIOSTOR = $obj->biostor;
		
	$url = 'http://localhost/citation-matching/api/biostor_format.php';
	...
	{
		echo 'UPDATE names SET citation = "' . str_replace('"', '""', trim($doc->citation)) . '" WHERE biostor="' . $doc->BIOSTOR . '";' . "\n";
	}
